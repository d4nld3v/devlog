...
const config: SiteConfig = {
  ...
  title: 'Devlog - D4nld3v',
  // The description of your site, used for SEO and RSS feed.
  description:
    'A coder-ready blog for sharing programming thoughts and experiences.',
  ...
  socialLinks: {
    github: 'https://github.com/d4nld3v',
    email: 'danielseoandweb@outlook.com',
    linkedin: 'https://www.linkedin.com/in/daniel-enr%C3%ADquez-baena-aa1347214/',
  },
